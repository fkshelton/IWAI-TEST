...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-earth-dark to-earth-brown text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl mb-4 text-earth-tan">
            ...
            <a
              href="#contact"
              className="inline-block bg-earth-green hover:bg-green-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition duration-300 transform hover:scale-105 shadow-lg"
            >
              Get a Free Quote
            </a>
          </div>
      ...
      <section id="services" className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-earth-dark mb-4">
              Our Services
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-lg p-6 text-center hover:shadow-xl transition duration-300 border border-earth-tan"
              >
      ...
      <section className="py-16 sm:py-20 bg-earth-tan bg-opacity-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-earth-dark mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {whyChooseUs.map((item, index) => (
              ...
              >
                <div className="text-5xl text-earth-green mb-4">{item.icon}</div>
      ...
      <section id="contact" className="py-16 sm:py-20 bg-earth-tan bg-opacity-20">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-8">
            <div className="mb-6">
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-earth-green"
              />
            </div>
            <div className="mb-6">
            ...
            <button
              type="submit"
              className="w-full bg-earth-green hover:bg-green-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition duration-300 shadow-lg"
            >
              Submit Request
            </button>
          </form>
      ...
      <footer className="bg-earth-dark text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            <div>
              <h3 className="text-2xl font-bold mb-4 text-earth-tan">Summit Fence Co</h3>
              <p className="text-gray-300">
                Quality fencing for Denver homes since 2009
              </p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4 text-earth-tan">Contact</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4 text-earth-tan">Hours</h4>
              <p className="text-gray-300 mb-2">
